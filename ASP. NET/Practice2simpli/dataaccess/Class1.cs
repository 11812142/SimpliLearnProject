...
namespace dataaccess
{
    ...
    { //-----------------------------------student details------------------------
        public bool Insert(BAL school)
        {
            ...
            SqlConnection cn = new SqlConnection("Data Source=DESKTOP-9E6TH3I\\SQLEXPRESS;Initial Catalog=school;Integrated Security=True");
       ...
       //---------------------------subjects details ----------------------------
        ...
        public bool Insert2(BAL school)
        {
            //  SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["NorthCnString"].ConnectionString);
            SqlConnection cn = new SqlConnection("Data Source=DESKTOP-9E6TH3I\\SQLEXPRESS;Initial Catalog=school;Integrated Security=True");
            SqlCommand cmdInsert = new SqlCommand("insert into classes(class_roomno,class_strength) values(@class_id,@class_strength)", cn);
            cmdInsert.Parameters.AddWithValue("@class_id", school.class_roomno);
        ...
        public bool Update2(BAL school)
        {
            ...
            cmdUpdate.CommandType = System.Data.CommandType.StoredProcedure;
            cmdUpdate.Parameters.AddWithValue("@p_classid", school.class_roomno);
